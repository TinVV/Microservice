                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p20b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://e7.pngegg.com/pngimages/59/635/png-clipart-digital-library-book-integrated-library-system-information-book-emblem-logo.png" alt="" width="100" title="Logo" class="adapt-img" style="display: block; font-size: 12px">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td esd-tmp-menu-padding="15|15" class="esd-block-menu">
                                              <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                                                <tbody>
                                                  <tr>
                                                    <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l esd-block-menu-item" style="padding-top: 15px; padding-bottom: 15px">
                                                      <div>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://etmyszc.stripocdn.email/content/guids/CABINET_f3fc38cf551f5b08f70308b6252772b8/images/96671618383886503.png" alt="" width="100" style="display:block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p20t es-p10b">
                                              <p style="line-height:150%">
                                                Got a question? Email us at tintran2712@gmail.com or give us a call at&nbsp;<a target="_blank" href="tel:" style="line-height:150%">+000 123 456</a>.
                                              </p>
                                              <p>
                                                <br>Thanks,
                                              </p>
                                              <p>
                                                Principle Back-end =&gt; Tin
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                                  ...
                                                  <tr>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Facebook" src="https://etmyszc.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="X" src="https://etmyszc.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Instagram" src="https://etmyszc.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top">
                                                      <a target="_blank" href="">
                                                        <img title="Youtube" src="https://etmyszc.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                      </a>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p35b">
                                              <p>
                                                Style Casual&nbsp;© 2025 Style Casual, Inc. All Rights Reserved.
                                              </p>
                                              <p>
                                                Tan Binh District, Ho Chi Minh City, VN, 72000
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
